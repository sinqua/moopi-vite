...
function Footer() {
    return (
        <div className="md:h-[239px] sm:h-[276px] h-[281px] sm:py-[60px] py-[50px] px-[17px] text-[14px] bg-[#F9F9F9] border-t-[1px] border-s2xyoon-gray ">
            <div className="flex sm:justify-center sm:flex-row flex-col md:h-[17px] h-auto sm:space-x-[28px] sm:space-y-0 space-y-[15px] font-SegoeUI font-semibold sm:mb-[40px] mb-[50px] flex-wrap">
            ...
            <div className="sm:flex hidden justify-center h-[17px] space-x-[10px] font-SegoeUI mb-[25px]">
                <div>MOOPI</div>
                <div>|</div>
            ...
            <div className="flex justify-center h-[20px] space-x-[20px] font-SegoeUI">
