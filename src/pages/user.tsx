    ...
    return (
        <Layout>
            <div className="flex flex-col items-center" onContextMenu={handleContextMenu}>
                    ...
                    <div className="relative md:w-[482px] sm:h-[526px] h-[602px] sm:p-[30px] p-[20px] flex flex-col rounded-[10px] shadow-[0px_3px_10px_rgba(0,0,0,0.16)]">
                        <div className="flex flex-row md:space-x-[20px] sm:space-x-[30px] space-x-[20px] mb-[30px] relative">
                            ...
                            <div className="flex flex-col justify-center space-y-[25px] grow">
                                <p className="font-SegoeUI font-semibold text-[18px]">shinQua</p>
                                <div className="flex flex-row font-SegoeUI text-[14px] flex-wrap md:justify-between md:space-x-0 sm:space-x-[50px] space-x-[30px]">
                        ...
                        <div className="font-SegoeUI sm:h-[159px] h-[238px] text-[14px] mb-[40px] leading-[25px]">
                        ...
                        <div className="flex flex-row space-x-[10px] justify-end mb-[20px] font-SegoeUI text-[14px]">
                            <div className="px-[22px] py-[8px] bg-[#E9E9E9] rounded-full">VRC</div>
                            <div className="px-[22px] py-[8px] bg-[#E9E9E9] rounded-full">blender</div>
                            <div className="px-[22px] py-[8px] bg-[#E9E9E9] rounded-full">이세계아이돌</div>
                        </div>
                        <div className="flex justify-center items-center h-[47px] bg-[#333333] rounded-[10px] font-SegoeUI text-[14px] text-white cursor-pointer">문의하기</div>
                        <div className="absolute flex justify-center md:w-[422px] w-[calc(100%-60px)] sm:bottom-[4px] bottom-[14px]">
                            <div className="inline-flex justify-center items-end sm:w-[368px] w-[296px] h-[71px] pb-[20px] sm:bg-[url('./assets/images/slotLg.png')] bg-[url('./assets/images/slotSm.png')] font-SegoeUI text-[14px] text-center align-text-bottom">
                ...
                <div className="mt-[60px] mb-[50px] flex justify-center w-full md:w-[1312px] md:px-0 sm:px-[30px] px-[20px] font-SegoeUI font-semibold sm:text-[20px] text-[14px]">
